...
import homeImg3 from "../public/homeImg.jpg";
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <h1 className="sm:text-5xl text-2xl font-medium title-font text-center text-gray-900 mb-8">Raw Denim Heirloom Man Braid
          ...
          {/* <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6 px-20">
            <div className="p-4 md:w-1/3 flex">
              <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-orange-300 text-indigo-500 mb-4 flex-shrink-0">
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                  <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
                </svg>
              </div>
              <div className="flex-grow pl-6">
                <h2 className="text-gray-900 text-2xl title-font font-medium mb-2">Shooting Stars</h2>
                ...
                <a className="mt-3 text-orange-300 inline-flex items-center">Learn More
            ...
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                <h2 className="text-gray-900 text-2xl title-font font-medium mb-2">The Catalyzer</h2>
                <p className="leading-relaxed text-lg">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug VHS try-hard ugh iceland kickstarter tumblr live-edge tilde.</p>
                <a className="mt-3 text-orange-300 inline-flex items-center">Learn More
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
            ...
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                <h2 className="text-gray-900 text-2xl title-font font-medium mb-2">Neptune</h2>
                <p className="leading-relaxed text-lg">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug VHS try-hard ugh iceland kickstarter tumblr live-edge tilde.</p>
                <a className="mt-3 text-orange-300 inline-flex items-center">Learn More
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
          ...
          <section className="text-gray-600 body-font">
            <div className="container px-5 mx-auto">
              <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                ...
                <p className="leading-relaxed text-lg">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 74s cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware. Man bun next level coloring book skateboard four loko knausgaard. Kitsch keffiyeh master cleanse direct trade indigo juice before they sold out gentrify plaid gastropub normcore XOXO 90s pickled cindigo jean shorts. Slow-carb next level shoindigoitch ethical authentic, yr scenester sriracha forage franzen organic drinking vinegar.</p>
                <span className="inline-block h-1 w-10 rounded bg-orange-300 mt-8 mb-2"></span>
                <h2 className="text-orange-400 font-medium title-font tracking-wider text-base">CEO - lps</h2>
              </div>
            </div>
          </section>
        </div>
      ...
      {/* <section className="text-gray-600 body-font">
        <div className="container px-5 py-4 mx-auto">
          <h1 className="sm:text-5xl text-2xl font-medium title-font text-center text-gray-900 mb-4">Selfies Wayfarers Man Braid
            <br className="hidden sm:block" />Raw Denim Heirloom
          </h1>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-4 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-5xl text-2xl font-medium title-font mb-4 text-gray-900">Master Cleanse Reliac Heirloom</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-lg">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably havent heard of them man bun deep jianbing selfies heirloom.</p>
          </div>
          <div className="flex flex-wrap -m-4 lg:px-32">
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                <Image height={200} width={200} alt="gallery" className="absolute inset-0 w-full h-full object-cover object-center" src="https://dummyimage.com/500x300" />
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-2xl text-2xl font-semibold title-font  mb-4 text-gray-900">Orato suite of social media platform integrations is unlike any other!</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed lg:text-xl text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably havent heard of them man bun deep.</p>
            <h2 className="text-gray-900 font-medium title-font tracking-wider text-lg pt-6">- HOLDEN CAULFIELD</h2>
        ...
        <section className="text-gray-600 body-font bg-[#F5F5F5]">
          ...
          <div className="container px-5  mx-auto">
            <div className="flex flex-col text-center w-full lg:pb-20 lg:pt-14 pb-5 pt-5">
              <h1 className="sm:text-5xl text-2xl font-medium title-font text-gray-900">Features At a Glance</h1>
            </div>
            ...
            <div className="flex flex-wrap -m-4 text-center lg:px-12 lg:pb-16">
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="text-orange-300 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
                    <path d="M8 17l4 4 4-4m-4-5v9"></path>
                    <path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29"></path>
                  </svg>
                  <h2 className="title-font font-medium text-3xl text-gray-900">creative speaking</h2>
                  <p className="leading-relaxed">Schedule, sit back and relax.</p>
                </div>
              </div>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <h2 className="title-font font-medium text-3xl text-gray-900">english</h2>
                  <p className="leading-relaxed">Schedule, sit back and relax.</p>
                </div>
              </div>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <h2 className="title-font font-medium text-3xl text-gray-900">listening</h2>
                  <p className="leading-relaxed">Schedule, sit back and relax.</p>
                </div>
              </div>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <h2 className="title-font font-medium text-3xl text-gray-900">Fab english</h2>
                  <p className="leading-relaxed">Schedule, sit back and relax.</p>
                </div>
              </div>
