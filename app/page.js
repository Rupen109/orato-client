            ...
            <div className="flex flex-wrap -m-4 text-center lg:px-12 lg:pb-16">
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" className="text-orange-300 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
